...
export default function TopSheet({ closeDirection, branchId }: TopSheetProps) {
  return (
    <div className='fixed top-4 z-10 h-[13rem] w-[70%] max-w-[30rem] rounded-xl bg-white px-4 py-4 max-[800px]:w-[52.5%] max-[715px]:pr-[0rem] max-[685px]:w-[57%] max-[630px]:w-[60%] max-[600px]:w-[72%] max-[565px]:w-[75%] max-[511px]:w-[80%] max-[480px]:w-[85%] max-[450px]:w-[90%] max-[400px]:w-[95%] max-[380px]:w-[97%] max-[370px]:w-[98%] max-[370px]:px-3 max-[350px]:pr-0'>
